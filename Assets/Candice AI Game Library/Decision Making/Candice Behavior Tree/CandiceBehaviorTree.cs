...
namespace CandiceAI.Games.DecisionMaking
{
    ...
    public class CandiceBehaviorTree
    {
        ...
        public void Initialise(List<Type> behaviorTypes)
        {
        ...
        public CandiceBehaviorNode CreateBehaviorTree(Transform transform, Action<CandiceBehaviorTreeEventData> _behviorTreeCallback)
        {
            //Initialise();
            rootNode = null;
